    ...
    >
      ...
      >
        <div className="block w-full h-full relative group/image overflow-hidden">
          ...
          <div className="absolute top-1/2 right-4 -translate-y-1/2 z-30 flex flex-col gap-2">
            ...
            <div className="opacity-0 group-hover/image:opacity-100 transition-opacity duration-300 ease-in-out delay-100">
              <button
                ...
                className="w-[40px] h-[40px] rounded-[12px] bg-white text-[#333] shadow-[0_4px_12px_rgba(0,0,0,0.08)] flex items-center justify-center border-none hover:bg-[#ca8a04] hover:text-white hover:shadow-[0_5px_15px_rgba(202,138,4,0.3)] transition-all duration-300 cursor-pointer transform hover:scale-110"
              >
          ...
          {stock > 0 && (
            <div className="absolute bottom-2 right-2 z-10 bg-yellow-600/90 backdrop-blur-sm border border-yellow-600 rounded-full px-3 py-1.5 shadow-lg group-hover/image:opacity-0 transition-opacity duration-1000 ease-in-out pointer-events-none">
            ...
            <div className="mt-auto pt-2 space-y-3">
              <div className="flex items-center gap-2">
                ...
                {(!product.related_products ||
                  ...
                  >
                    <Button
                      variant="outline"
                      size="icon"
                      className="h-9 w-9 flex-shrink-0 border-input hover:bg-yellow-600 hover:text-white transition-colors"
                ...
                <Button
                  ...
                  size="icon"
                  className={cn(
                    "h-9 w-9 flex-shrink-0 border-input hover:bg-yellow-600 hover:text-white transition-colors",
