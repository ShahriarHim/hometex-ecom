          ...
          <div className="p-4 border-t border-gray-700">
            ...
            <div className="grid grid-cols-3 gap-2">
              <button
                ...
                className="h-10 flex items-center justify-center gap-2 bg-black text-white border border-white hover:bg-gray-800 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 text-sm font-medium disabled:opacity-50 disabled:cursor-not-allowed px-2"
                title="Remove All"
              >
              ...
              <button
                ...
                className="h-10 flex items-center justify-center gap-2 bg-black text-white border border-white hover:bg-gray-800 rounded-lg shadow-md hover:shadow-lg transition-all duration-300 text-sm font-medium px-2"
                title="View Cart"
              >
                <div className="w-4 h-4 flex items-center justify-center flex-shrink-0">
              ...
              {isAuthenticated ? (
                ...
                <button
                  disabled
                  className="h-10 flex items-center justify-center gap-2 bg-gray-600 text-gray-400 border border-gray-500 rounded-lg text-sm font-medium cursor-not-allowed px-2"
                >
                  <div className="w-4 h-4 flex items-center justify-center flex-shrink-0">
                    <FaShoppingCart className="w-full h-full" />
                  </div>
