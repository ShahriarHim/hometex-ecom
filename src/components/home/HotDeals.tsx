...
import { ArrowRight, Clock, Eye, Heart, ShoppingCart } from "lucide-react";
        ...
        <div className={styles["hot-deals-box"]}>
          <div className={styles["hot-deals-header"]}>
            ...
            <Link
              ...
              className={`${styles["see-all-link"]} inline-flex items-center`}
            >
              Explore All
          ...
          <div className="flex">
            <div className="bg-yellow-600 p-4 rounded-lg text-center text-white mr-5 flex-shrink-0">
              <div className="mb-3">
                <div className="w-12 h-12 bg-yellow-700/50 rounded-full flex items-center justify-center mx-auto">
