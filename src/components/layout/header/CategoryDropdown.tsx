                  ...
                  <div className="flex items-center gap-0.5">
                    ...
                    {hasChildren && (
                      <button
                        ...
                        className="p-0.5 rounded transition-colors flex-shrink-0 ml-1 group/toggle"
                        aria-label={isExpanded ? "Collapse" : "Expand"}
                      >
                        <ChevronRight
                          className={`w-4 h-4 text-yellow-600 group-hover/toggle:text-yellow-500 transition-transform duration-200 ${
