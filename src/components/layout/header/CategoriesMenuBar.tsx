              ...
              <ul className="flex items-center justify-start gap-1 lg:gap-4 py-2 min-w-max">
                ...
                <li className="relative">
                  <Link
                    href="/products"
                    className={cn(
                      "inline-flex h-10 items-center justify-center rounded-md px-4 py-2 text-sm font-semibold uppercase whitespace-nowrap transition-all duration-200",
                      " text-black hover:bg-yellow-600 hover:text-foreground"
                    )}
                  >
