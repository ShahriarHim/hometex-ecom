...
import { Heart, Loader2, RefreshCw, Shield, ShoppingCart, Star, Truck } from "lucide-react";
  ...
  useEffect(() => {
    const fetchProduct = async () => {
      ...
      try {
        ...
        // Handle both response formats: { success: true, data: product }, { success: true, data: { product: ... } } or direct product
        ...
        if (
          ...
          (productData as { product: unknown }).product
        ) {
          productData = (productData as { product: unknown }).product as APIProduct;
        }
