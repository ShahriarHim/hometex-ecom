...
export const CategorySpotlight = () => {
  ...
  return (
    <div className="max-w-[1360px] mx-auto px-4 mb-8">
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 items-stretch">
        {/* Part 1: Featured Section - "Our Top Category" Static Card */}
        <div className="md:col-span-1 text-center relative z-10 hidden md:block">
          <div className="flex items-center p-5 text-xl font-bold text-black rounded-lg shadow-xl bg-gradient-to-br h-full min-h-[200px] from-yellow-600 to-amber-400">
            <div className="absolute right-[-20px] top-1/2 -translate-y-1/2 bg-white/90 backdrop-blur-xl rounded-lg h-[120px] w-[200px] flex justify-center items-center shadow-2xl border border-white/20">
              <p className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-yellow-600 to-amber-500">
                Our Top <br /> Category
              </p>
            </div>
          </div>
        ...
        <div className="md:col-span-3 rounded-2xl overflow-hidden">
          ...
          >
            {categories.map((category, index) => (
              <SwiperSlide key={`${category.id}-${index}`} className="h-auto p-1">
                <Link
                ...
                >
                  ...
                  <div className="p-4 bg-white relative">
                    <h3 className="text-lg font-bold text-center text-gray-800 group-hover:text-yellow-600 transition-colors duration-300 truncate">
                      {category.name}
                    </h3>
                    <div className="w-10 h-1 bg-gray-200 mx-auto mt-2 rounded-full group-hover:bg-yellow-600 transition-colors duration-300" />
                  </div>
                </Link>
              </SwiperSlide>
            ))}
