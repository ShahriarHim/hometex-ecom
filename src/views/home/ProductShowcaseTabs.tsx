      ...
      <div className="max-w-[1360px] mx-auto px-4">
        <div className="flex flex-col lg:flex-row justify-between gap-6 lg:items-end">
          <div className="space-y-3">
            <p className="text-sm uppercase tracking-[0.3em] text-foreground">
          ...
          <Button asChild className="bg-black text-white border border-white hover:bg-gray-800">
            <Link href="/products">
              Explore All
                ...
                {tabs.map((tab) => {
                  ...
                  return (
                    <TabsTrigger
                      key={tab.id}
                      value={tab.id}
                      className="flex items-center gap-2 rounded-full border border-black text-black px-4 py-2 text-sm transition-all data-[state=active]:bg-black data-[state=active]:text-white"
                    >
                ...
                return (
                  <TabsContent key={tab.id} value={tab.id} className="mt-8">
                    {isLoading ? (
                      ...
                      <div className="flex items-center justify-center min-h-[400px]">
                        <p className="text-foreground">No products available in this category.</p>
                      </div>
                    ) : (
